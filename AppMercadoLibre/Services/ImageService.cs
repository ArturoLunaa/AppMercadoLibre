...
namespace AppMercadoLibre.Services
{
    public class ImageService
    {
        ...
        //Función para convertir una imagen base 64 a ImageSource
        ...
        public async Task<string> ConvertImageFileToBase64(string filePath)
        {
            if (!string.IsNullOrEmpty(filePath))
            {
                ...
                await stream.ReadAsync(bytes, 0, (int)bytes.Length);
                return System.Convert.ToBase64String(bytes);
            }
            return String.Empty;
        }

        // Función para guardar una imagen en formato base 64 concatenando el id enviado
